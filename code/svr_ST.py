...
def main(datadir, dataname, lead_time,
    ...
    np.save("inputdata", svr_input)
    np.save("xunlianbiaoqian", data_train_y)
    ...
    np.save("ceshijishuju", svr_input_test)
...
if __name__ == '__main__':
    ...
    p.add_argument('--modelname', type=str, default='svr-1days-daily-ST-prediciton', help='name for prediction model')
    args = p.parse_args()
